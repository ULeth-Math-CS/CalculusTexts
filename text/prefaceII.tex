...
This document is an attempt to provide a textbook that covers the entire curriculum (as of January 2016) for the course Math 2560 (Calculus II) at the University of Lethbridge at minimal cost to the student.

Since Math 2560 covers elements of calculus of both one and several variables, most students will have purchased a textbook for Math 1560 that does not contain everything that they need for Math 2560. There are many commercially available textbooks that cover this material, but none are affordable, especially for a one semester course. 
