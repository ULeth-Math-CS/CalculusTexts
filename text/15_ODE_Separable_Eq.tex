...
We check:
\begin{equation*}
y\primeskip ' = D x e^{\frac{x^2}{2}} = x \left( D e^{\frac{x^2}{2}} \right) = xy .
\end{equation*}
It works!
}\\
...
to get
\begin{equation*}
y\primeskip '\left(2y + \frac{2}{y}\right) = 2x .
\end{equation*}
...
Solve $x^2y\primeskip ' = 1 - x^2+y^2 - x^2y^2$, $y(1) = 0$.}
{
First factor the right hand side to obtain
\begin{equation*}
x^2y\primeskip ' = (1 - x^2)(1+y^2) .
\end{equation*}
Separate variables, integrate, and solve for $y$.
\begin{align*}
\frac{y\primeskip '}{1+y^2} & = \frac{1 - x^2}{x^2} , \\
\frac{y\primeskip '}{1+y^2} & = \frac{1}{x^2} - 1 , \\
...
Find the general solution to $y\primeskip ' = \frac{-xy^2}{3}$ (including singular
solutions).}
{
First note that $y=0$ is a solution (a singular solution).
So assume that $y \not= 0$ and write
\begin{align*}
\frac{-3}{y^2} y\primeskip ' & = x , \\
...
\printexercises{exercises/15_04_exercises}
