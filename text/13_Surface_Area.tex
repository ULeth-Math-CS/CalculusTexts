...
3Dlights=Headlamp,add3Djscript=asylabels.js}{width=150pt}{figures/figsurfacearea_intro1}\\
...
3Dlights=Headlamp,add3Djscript=asylabels.js}{width=150pt}{figures/figsurfacearea_intro2}\\
...
3Dlights=Headlamp,add3Djscript=asylabels.js}{width=150pt}{.45}{Finding the area of a triangle in space in Example \ref{ex_surfacearea1}.}{fig:surfacearea1}{figures/figsurfacearea1}%
}
...
\mnote{.7}{\textbf{Note:} The inner integral in Equation \eqref{eq:exsurfacearea2} is an improper integral, as the integrand of $\ds \int_0^ar\sqrt{\frac{a^2}{a^2-r^2}}\ dr$ is not defined at $r=a$. To properly evaluate this integral, one must use the techniques of Section \ref{II-sec:improper_integration}.\\
...
\]
shown in Figure \ref{fig:surfacearea3}. Find the surface area of this cone.
\mfigurethree{width=150pt,3Dmenu,activate=onclick,deactivate=onclick,
3Droll=0.,
3Dortho=0.0046491301618516445,
...
3Dlights=Headlamp,add3Djscript=asylabels.js}{width=150pt}{.25}{Finding the surface area of a cone in Example \ref{ex_surfacearea3}.}{fig:surfacearea3}{figures/figsurfacearea3}
...
\[
f_x(x,y) = -\frac{xh}{a\sqrt{x^2+y^2}}\quad \text{and}\quad f_y(x,y)=-\frac{yh}{a\sqrt{x^2+y^2}}.
\]
...
\mnote{.8}{\textbf{Note:} Once again $f_x$ and $f_y$ are not continuous on the domain of $f$, as both are undefined at $(0,0)$. (A similar problem occurred in the previous example.) Once again the resulting improper integral converges and the computation of the surface area is valid.
}
...
3Dlights=Headlamp,add3Djscript=asylabels.js}{width=150pt}{.3}{Graphing the surface in Example \ref{ex_surfacearea4}.}{fig:surfacearea4}{figures/figsurfacearea4}
