...
We are often interested in knowing the area of a region. Forget momentarily that we addressed this already in Section  \ifthenelse{\boolean{CalcI}}{\ref{chapter:integration}.\ref{sec:FTC}}{\ref{I-chapter:integration}.\ref{I-sec:FTC}} and approach it instead using the same partitioning arguments we used to identify the definite integral as a limit of Riemann sums.
