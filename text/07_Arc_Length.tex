...
\end{align*}
\mfigure{.4}{A graph of $f(x) = x^{3/2}$ from Example \ref{ex_arc1}.}{fig:arc1}{figures/figarc1}	
...
%\clearpage
\mtable{.65}{The solids used in Example \ref{ex_sa2}.}{fig:sa2}{%
\begin{tabular}{c}
\myincludegraphicsthree{width=125pt,3Dmenu,activate=onclick,deactivate=onclick,
...
3Dlights=Headlamp,add3Djscript=asylabels.js}{}{.25}{A graph of Gabriel's Horn.}{fig:gabriel}{figures/figgabriel}
