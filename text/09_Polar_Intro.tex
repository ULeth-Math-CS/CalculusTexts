...
{Given the polar point $P(r,\theta)$, the rectangular coordinates are determined by 
\[
...
\enlargethispage{2\baselineskip}
	...
	\item \begin{enumerate}
		...
		\[
		\tan\theta = -1 \quad \Rightarrow \quad \theta = \tan^{-1}(-1) = -\pi/4 = -45^\circ.
		\]
...
We can consider the rectangular equivalent of this equation; using $r^2=x^2+y^2$, we see that $1.5^2=x^2+y^2$, which we recognize as the equation of a circle centred at $(0,0)$ with radius 1.5. This is sketched in Figure \ref{fig:polar3}.
