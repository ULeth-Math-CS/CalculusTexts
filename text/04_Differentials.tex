...
\mnote{.75}{\textbf{Note:} The function
\[
\ell(x) = f(c) + f'(c)(x-c)
\]
is known as the \sword{linearization}\index{linearization} of $f$ at $c$. It is the linear function that best approximates the values of $f$ near $c$.}
...
{\mtable{.4}{Graphing $f(x) = \sin x$ and its tangent line at $x=\pi/3$ in order to estimate $\sin 1.1$.}{fig:diffal1}{\begin{tabular}{c}
