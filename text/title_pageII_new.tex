...
\Huge  Math 2560 Calculus II\\

\Large University of Lethbridge 

Custom edition assembled by Sean Fitzpatrick using text from the authors below, except Chapter 4 on Differential Equations, which is adapted from the text {\em Notes on Diffy Q's}, by Ji{\v r}\'i Lebl
