...
3Dlights=Headlamp,add3Djscript=asylabels.js}{width=150pt}{.75}{Graphing the planes and their line of intersection in Example \ref{ex_planes4}.}{fig:planes4}{figures/figplanes4}
...
3Dlights=Headlamp,add3Djscript=asylabels.js}{width=150pt}{.5}{Illustrating the intersection of a line and a plane in Example \ref{ex_planes5}.}{fig:planes5}{figures/figplanes5}
...
\begin{equation}\snorm{\text{proj}_{\,\vec n}\,{\vv{PQ}}} = \snorm{\frac{\vec n\cdot \vv{PQ}}{\vnorm n^2}\vec n} = \frac{\lvert\vec n\cdot \vv{PQ}\rvert}{\vnorm n}\label{eq:plane_dist}
\end{equation}
...
3Droo=149.9999995928182,
3Dlights=Headlamp,add3Djscript=asylabels.js}{width=150pt}{.2}{Illustrating finding the distance from a point to a plane.}{fig:planes_dist}{figures/figplanes_dist}
...
\[
h = \frac{\lvert\vec n\cdot \vv{PQ}\rvert}{\vnorm n},
\]
...
\begin{align*}
h &= \frac{\lvert\vec n\cdot \vv{PQ}\rvert}{\vnorm n} \\
  &= \frac{\lvert\la 2,-5,-6\ra \cdot \la 2,1,2.5\ra\rvert}{\norm{\la 2,-5,-6\ra}} \\
	&= \frac{ \lvert -16\rvert}{\sqrt{65}} \\
	&\approx 1.98.
\end{align*}
\vskip-2\baselineskip
}\\

As we mentioned in \ref{sec:lines}, it is usually better to understand a method for calculating distances like that in \ref{ex_planes6}, rather than memorizing a formula. Let us repeat the example using a more systematic approach.\\

\example{ex_planes6a}{Distance between a point and a plane}{
...
\begin{align*}
\operatorname{proj}_{\vec n}\overrightarrow{PQ} & = \left(\frac{\overrightarrow{PQ}\boldsymbol{\cdot}\vec n}{\norm{\vec n}^2}\right)\vec n\\
...
\[
\norm{\operatorname{proj}_{\vec n}\overrightarrow{PQ}} = \frac{14}{65}\norm{\la 2, -5, 6\ra} = \frac{14}{\sqrt{65}}.
\]
\vskip-2\baselineskip
}\\
