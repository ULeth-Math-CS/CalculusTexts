...
\mnote{.65}{Alternate notations for the derivative of $\vec r$ include: $$\vrp(t) = \frac{d}{dt}\big(\,\vec r(t)\,\big) = \frac{d\vec r}{dt}.$$}
%}\\
...
3Droo=150.0000027221829,3Dlights=Headlamp,add3Djscript=asylabels.js}{}{.4}{Viewing a vector--valued function and its derivative at one point.}{fig:vvflimit4}{figures/figvvflimit4}
}%% ends "if in threeD"
...
3Dlights=Headlamp,add3Djscript=asylabels.js}{}{.18}{Graphing a curve in space with its tangent line.}{fig:vvfderiv1}{figures/figvvfderiv1}
}%end in threeD
