...
Solve
\begin{equation*}
y\primeskip ' + 2xy = e^{x-x^2}, \qquad y(0) = -1 .
\end{equation*}}
{
...
$y\primeskip ' + p(x) y = f(x)$, $y(x_0) = y_0$,
...
with the simple nonlinear example we have seen previously, $y\primeskip '=y^2$,
...
\printexercises{exercises/15_05_exercises}
