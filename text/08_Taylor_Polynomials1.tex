...
\mnote{.65}{The notation $k!$ is read as ``$k$ factorial''. By convention, we also define $0!=1$, mostly because it makes our formulas look a lot nicer.}
...
\mnote{.7}{Colin Maclaurin was a Scottish mathematician, born in 1698. He lived until 1746, and made a number of contributions to the development of mathematics and physics. He was elected professor of mathematics at the University of Aberdeen at the age of 19, setting a record as the world's youngest professor, which he held until 2008! He was also a staunch foe of the Jacobite Rebellion, and organized the defence of Edinburgh against the army of Bonnie Prince Charlie.}
