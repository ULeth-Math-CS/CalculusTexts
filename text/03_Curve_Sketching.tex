...
\begin{tikzpicture}[>=latex]
  \draw [thick, <->] (-3,0) -- (3,0);
  \draw [fill] (-1,0) circle [radius =.08];
  \draw (-1,-0.1) node[below] {\scriptsize \parbox{40pt}{\centering $c_1$}};
  \draw [fill] (1,0) circle [radius =.08];
  \draw (1,-0.1) node[below] {\scriptsize \parbox{40pt}{\centering $c_2$}};
  \draw (-2,.25) node {$+$};
...
\begin{tikzpicture}[>=latex]
  \draw [thick, <->] (-3,0) -- (3,0);
  \draw [fill] (-1,0) circle [radius =.04];
  \draw (-1,-0.1) node[below] {\scriptsize \parbox{40pt}{\centering $c_1$}};
  \draw [fill] (1,0) circle [radius =.04];
  \draw (-1,-0.1) node[below] {\scriptsize \parbox{40pt}{\centering $c_2$}};
  \draw [fill] (0,0) circle [radius =.08];
  \draw (0,-0.1) node[below] {\scriptsize \parbox{40pt}{\centering $\dfrac{10}{9}$}};
  \draw (-2,.25) node {$-$};
  \draw (-2,-.75) node {\scriptsize \parbox{50pt}{\centering $\fpp<0$ \ c. down}};
  \draw (2,.25) node {$+$};
  \draw (2,-.75) node {\scriptsize \parbox{50pt}{\centering $\fpp>0$ \ c. up}};
\end{tikzpicture}
\end{center}
\captionsetup{type=figure}%
...
\begin{tikzpicture}[>=latex]
  ...
  \foreach \x in {-4,0,4}
  			{\draw (\x,.25) node {$+$};
  			 \draw (\x,-.75) node {\scriptsize \parbox{50pt}{\centering $f>0$}};}
  \foreach \x in {-2,2}
  			{\draw (\x,.25) node {$-$};
  			 \draw (\x,-.75) node {\scriptsize \parbox{50pt}{\centering $f<0$}};}		 
\end{tikzpicture}
...
\begin{tikzpicture}[>=latex]
  \draw [thick, <->] (-4,0) -- (4,0);
  \draw [fill=white] (-2.0,0) circle [radius =.08];
  \draw (-2,-0.1) node[below] {\scriptsize \parbox{40pt}{\centering $-2$}};
  \draw [fill] (0,0) circle [radius =.08];
  \draw (0,-0.1) node[below] {\scriptsize \parbox{40pt}{\centering $\dfrac12$}};
  \draw [fill=white] (2,0) circle [radius =.08];
  \draw (2,-0.1) node[below] {\scriptsize \parbox{40pt}{\centering $3$}};
  \draw (-3,.25) node {$+$};
  \draw (-3,-.75) node {\scriptsize \parbox{50pt}{\centering $\fp>0$ \ incr }};
  \draw (-1,.25) node {$+$};
  \draw (-1,-.75) node {\scriptsize \parbox{50pt}{\centering $\fp>0$ \ incr }};
  \draw (1,.25) node {$-$};
  \draw (1,-.75) node {\scriptsize \parbox{50pt}{\centering $\fp<0$ \ decr }};
  \draw (3, .25) node {$-$};
  \draw (3,-.75) node {\scriptsize \parbox{50pt}{\centering $\fp<0$ \ decr }};
    \end{tikzpicture}
\end{center}
\captionsetup{type=figure}%
...
\begin{tikzpicture}[>=latex]
  \draw [thick, <->] (-3,0) -- (3,0);
  \foreach \x / \y in {-1/$-2$,1/$3$}
  {\draw [fill=white] (\x,0) circle [radius=.08];
   \draw (\x,-0.1) node[below]  {\scriptsize \parbox{40pt}{\centering \y}};}
  \draw (-2,.25) node {$+$};
  \draw (-2,-.75) node {\scriptsize \parbox{50pt}{\centering $\fpp>0$ \ c. up}};
  \draw (0,.25) node {$-$};
  \draw (0,-.75) node {\scriptsize \parbox{50pt}{\centering $\fpp<0$ \ c. down}};
  \draw (2, .25) node {$+$};
  \draw (2,-.75) node {\scriptsize \parbox{50pt}{\centering $\fpp>0$ \ c. up}};
  \end{tikzpicture}
\end{center}
...
\begin{tikzpicture}[>=latex]
  ...
  \foreach \x / \y in {-1/$-1$,1/$2$}
  		{\draw [fill] (\x,0) circle [radius=.08];
  		 \draw (\x,-0.1) node[below]  {\scriptsize \parbox{40pt}{\centering \y}};}
  \draw (-2,.25) node {$+$};
  \draw (-2,-.75) node {\scriptsize \parbox{50pt}{\centering $f>0$}};
  \draw (0, .25) node {$-$};
  \draw (0,-.75) node {\scriptsize \parbox{50pt}{\centering $f<0$}};
  \draw (2, .25) node {$+$};
  \draw (2,-.75) node {\scriptsize \parbox{50pt}{\centering $f>0$}};
  \end{tikzpicture}
\end{center}
...
\begin{tikzpicture}[>=latex]
     \draw [thick, <->] (-4,0) -- (4,0);
  \foreach \x / \y in {-2/$c_1$,0/$c_2$,2/$c_3$}
  		{\draw [fill] (\x,0) circle [radius=.08];
  		 \draw (\x,-0.1) node[below]  {\scriptsize \parbox{40pt}{\centering \y}};}
  \draw (-3,.25) node {$-$};
  \draw (-3,-.75) node {\scriptsize \parbox{50pt}{\centering $\fpp<0$ \ c. down}};
  \draw (-1, .25) node {$+$};
...
In fact, in the interval of length $0.2$ centered around $\pi/2$, \textit{Mathematica} plots 72 of the 431 points plotted; that is, it plots about 17\% of its points in a subinterval that accounts for about 3\% of the total interval length.
