...
We now practice  parametrizing surfaces. \pagebreak

\example{ex_parsurf1}{Parametrizing a surface over a rectangle}
{Parametrize the surface $z=x^2+2y^2$ over the rectangular region $R$ defined by $-3\leq x\leq 3$, $-1\leq y\leq 1$. 
}
{
There is a straightforward way to parametrize a surface of the form $z=f(x,y)$ over a rectangular domain. %Parametrizing surfaces, given in the form $z=f(x,y)$ over rectangular regions is straightforward. 
...
\example{ex_parsurf2}{Parametrizing a surface over a circular disk}
...
\example{ex_parsurf3}{Parametrizing a surface over a triangle}
...
\example{ex_parsurf4}{Parametrizing a surface over a triangle}
...
\keyidea{idea:parameterizing_surfaces}{Parametrizing Surfaces}
...
\example{ex_parsurf5}{Parametrizing a cylindrical surface}
...
\example{ex_parsurf6}{Parametrizing an elliptic cone}
...
\example{ex_parsurf7}{Parametrizing an ellipsoid}
