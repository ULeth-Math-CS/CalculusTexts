...
3Dlights=Headlamp,add3Djscript=asylabels.js}{width=150pt}{.78}{Showing various lines tangent to a surface.}{fig:space_tangent_intro}{figures/figspace_tangent_intro}
...
3Dlights=Headlamp,add3Djscript=asylabels.js}{width=150pt}{.5}{Graphing a surface with a normal line  from Example \ref{ex_tpl3}.}{fig:tpl3}{figures/figtpl3}
...
\printexercises{exercises/12_06_exercises2570}
