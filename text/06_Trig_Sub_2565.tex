\section{Trigonometric and Hyperbolic Substitution}\label{sec:trig_sub}
...
For integrands containing terms of the form $\sqrt{x^2+a^2}$ or $\sqrt{x^2-a^2}$, it is also possible to make use of \sword{hyperbolic substitution} \index{substitution ! hyperbolic}. Recall from Section \ref{I-sec:hyperbolic} of your Calculus I textbook that the hyperbolic functions are defined by
\[
...
\printexercises{exercises/06_08_exercises_2565}
